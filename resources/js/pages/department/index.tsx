    ...
    return (
        <AuthenticatedLayout>
            <Head>
                ...
                <link rel="canonical" href={product.byDepartment(department.slug).url} />

                <meta property="og:title" content={department.name} />
                <meta property="og:description" content={department.meta_description} />
                <meta property="og:url" content={product.byDepartment(department.slug).url} />
                <meta property="og:type" content={"website"} />
                <meta property="og:site_name" content={name} />
            </Head>

            <div className="container mx-auto">
                <div className="her bg-base-200 min-h-[120px]">
